...
- Receipt fields and failure handling are defined in the [reviewer procedure](../../skills/gsd-path/references/jev-review.md#reviewer-procedure); service safeguards are defined in its [service behavior](../../skills/gsd-path/references/jev-review.md#service-behavior) section.
